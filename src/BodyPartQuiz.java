...
for (int i = 0; i < 4; i++) {
			...
			if (guess.equalsIgnoreCase("arnold")) {
				...
				JOptionPane.showMessageDialog(null, "You are wrong. It was Arnold.");
			...
			if (guess.equalsIgnoreCase("Leonardo")) {
				...
				JOptionPane.showMessageDialog(null, "You are wrong. It was Leonardo.");
			...
			if (guess.equalsIgnoreCase("morgan")) {
				...
				JOptionPane.showMessageDialog(null, "You are wrong. It was Morgan.");
			...
			if (guess.equalsIgnoreCase("jack")) {
				...
				JOptionPane.showMessageDialog(null, "You are wrong. It was Jack.");
